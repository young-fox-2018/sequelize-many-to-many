...
routes.get('/student/addSubject/:id', (req, res) => {
        studentController.viewAddSubject(req, res)
})

routes.post('/student/addSubject/:id', (req, res) => {
        studentController.postAddSubject(req, res)
})
...
routes.get('/subjects/:id/enrolled-students', (req, res) => {
        subjectController.getSubjectDetail(req, res)
})
